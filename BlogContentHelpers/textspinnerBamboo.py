...
# 							Code Descrition
# This codule gets content from webpage -> jumbles flips it sentences and
#  print output. and further needs to pass to sext spinners to change the 
#  base identity of article
