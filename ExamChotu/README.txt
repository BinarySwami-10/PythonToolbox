...
License:
if you want to change the code and use it for different application, kindly remove my name then redistribute. as i do not wish to get troubles. any malfunction in code before you modify this is solely my responsibility.

USAGE GUIDE:
Do not change the contents of the folder if you are not a programmer.
page.html contains the markup. you need to manually add it by inspecting 
...
you need firefox  installed for this thing to work by default as we used gecko driver. 
or download chrome selenium driver and paste it in this folder.
